...
This is the main entry point for the AstraHeadController firmware. It initializes configuration, display, and communication subsystems, then enters a loop to process incoming commands, update servo positions, and provide feedback. The code manages configuration storage, torque control, and real-time communication, ensuring precise head movement and system integration.
*/
#include <Arduino.h>
#include <SCServo.h>
