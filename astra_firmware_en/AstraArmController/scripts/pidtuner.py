...
class PIDTunerRunner:
    def __init__(self):
        ...
        gui_thread.daemon = True  # Daemon thread, automatically exits when main thread ends
        gui_thread.start()

    def run_gui(self):
        """Thread to run Tkinter GUI"""
        self.app = PIDTuner()
