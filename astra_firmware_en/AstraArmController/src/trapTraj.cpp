...
This file implements the trapezoidal trajectory planning algorithm for the AstraArmController firmware.
It provides functions to plan and evaluate motion profiles with acceleration, cruising, and deceleration phases, 
ensuring smooth and efficient motor movements based on kinematic constraints.
*/
