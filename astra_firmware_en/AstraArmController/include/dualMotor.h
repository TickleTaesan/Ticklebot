...
#define JOINT_NUM 6 // Single-motor-per-joint arm
// #define NONE_JOINT_NUM 4 // Not used anymore: no non-joint motors
...
// Above PID params are still used for single-motor joints
