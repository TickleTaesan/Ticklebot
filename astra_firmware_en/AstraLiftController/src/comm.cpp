...
This file implements the communication protocol for the AstraLiftController firmware. It provides functions for serial initialization, sending and receiving data packets, and handling different communication types. The protocol supports both blocking and non-blocking operations, with mechanisms for packet validation and buffer management. It is designed for robust and real-time data exchange between the lift controller and other system components.
*/
#include "comm.h"
#include <string.h>
#include <Arduino.h>
