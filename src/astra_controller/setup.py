...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'moveit_pose_bridge = astra_controller.moveit_pose_bridge:main',
            'tickle_moveit_relay_node = astra_controller.tickle_moveit_relay_node:main',
            'hardware_relay_node = astra_controller.hardware_relay_node:main',
            ...
            'test_tickle_goal_pose = astra_controller.scripts.test_tickle_goal_pose:main',
            'test_goal_pose_node = astra_controller.test_goal_pose_node:main',
        ],
    },
)
