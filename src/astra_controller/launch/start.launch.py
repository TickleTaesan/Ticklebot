...
def generate_launch_description():
    ...
    # Cameras - commented out for testing
    # ld.add_action(
    #     Node(
    ...
    # Real Arms - commented out to use dry run node
    # ld.add_action(
    #     Node(
    ...
    #             'gripper_joint_names': ["joint_l7r", "joint_l7r"],  # Duplicate for compatibility
    #         }],
    #         remappings=[
    #             ('joint_states', '/joint_states'),
    ...
    # Right arm commented out for testing
    # ld.add_action(
    #     Node(
    #         package=package_name,
    #         executable="lift_node",
   ...
   # Fake Arms - using dry run node for testing
    ...
    # Head - commented out due to missing device
    # ld.add_action(
    #     Node(
    #         package=package_name,
